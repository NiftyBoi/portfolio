...
function About() {
  return (
      <div className='flex flex-col md:flex-row items-center items-center justify-center gap-10 max-w-6xl mx-auto px-4'>
        <div className="flex flex-col items-center md:items-start md:w-1/2 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-bold mb-6 text-[#A52A2A]">Matias Cruz</h1>
            <img src="https://c.tenor.com/4XYAgRvDR2QAAAAd/tenor.gif" alt="Luffy" className='h-auto rounded-xl shadow-xl'/>
        </div>
        <div className="md:w-1/2">
            <p className='text-lg text-white mb-10 font-Lato'>
